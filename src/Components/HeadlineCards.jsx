    ...
    <div className='max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6'>
      ...
      <div className='rounded-xl relative'>
        ...
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          ...
          <button className='border-solid border-white border-2 hover:bg-orange-500 hover:text-white text-white px-2 rounded-full tracking-widest mx-2 absolute bottom-4'>Order Now</button>
        </div>
        <img
